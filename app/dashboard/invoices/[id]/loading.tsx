          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="flex-1 min-w-0 space-y-6">
              ...
              <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-sidebar)] p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-4 border-t border-[var(--border-subtle)]">
                  {[0, 1, 2, 3].map((i) => (
              ...
              <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-sidebar)] overflow-hidden">
                ...
                <div className={`h-[360px] sm:h-[500px] ${BAR.replace('rounded', '')} m-4 rounded-lg`} />
              </div>
            </div>
          </div>
        </div>
